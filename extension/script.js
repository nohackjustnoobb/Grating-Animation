var canvas, ctx, total_images, images = [],
    grating, controller;
...
function drawImage() {
    ...
    img.onload = function () {
        ...
        [].forEach.call(images, function (img_src) {
            ...
            image.onload = function () {
                ...
                for (var j = i * pixel_size; j <= canvas.width; j += pixel_size * total_images) {
...
function loadaudio() {
    ...
    audio_reader.onload = function () {
        document.getElementById("contols").innerHTML = "<audio controls><source id=\"audio_src\"></audio>";
...
function generator() {
    var speed = 22 - document.getElementById("speed").value * 2;
